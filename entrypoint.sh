...
echo "Building DEPLOYMENT_REPO"
echo "$DEPLOYMENT_REPO"
...
echo "Building2 DEPLOYMENT_REPO"
echo "$DEPLOYMENT_REPO"

echo "Building DEPLOYMENT_REPO_TOKEN"
echo "$DEPLOYMENT_REPO_TOKEN"

export DEPLOYMENT_REPO_TOKEN=${INPUT_DEPLOYMENT_REPO_TOKEN}

echo "Building2 DEPLOYMENT_REPO_TOKEN"
echo "$DEPLOYMENT_REPO_TOKEN"
